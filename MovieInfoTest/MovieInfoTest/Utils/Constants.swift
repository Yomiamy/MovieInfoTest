...
class Constants {
    ...
    static let API_KEY:String = "328c283cd27bd1877d9080ccb1604c91"
    ...
    static let BOOK_MOVIE_URL_PREFIX:String = "https://www.themoviedb.org/movie/"
    
    static let ROUTE_SHOW_MOVIE_DETAIL = "show_movie_detail"
    static let ROUTE_SHOW_WEB_VIEW = "show_web_view"
}
